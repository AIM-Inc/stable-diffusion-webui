...
class Script(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        pixels = gr.Slider(
            label="Pixels to expand", minimum=8, maximum=256, step=8, value=128
        )
        mask_blur = gr.Slider(
            label="Mask blur", minimum=0, maximum=64, step=1, value=8, visible=False
        )
        ...
        color_variation = gr.Slider(
            label="Color variation", minimum=0.0, maximum=1.0, step=0.01, value=0.05
        )
