...
from modules import localization, sd_models, sd_samplers
from modules.artists import ArtistsDatabase
...
artist_db = ArtistsDatabase(os.path.join(script_path, "artists.csv"))
