...
def get_deepbooru_tags(pil_image):
    ...
    try:
        create_deepbooru_process(
            shared.opts.interrogate_deepbooru_score_threshold, create_deepbooru_opts()
        )
    ...
    while True:  # while process is running, keep monitoring queue for new image
        ...
        if pil_image == "QUIT":
            ...
            deepbooru_process_return["value"] = get_deepbooru_tags_from_model(
                model, tags, pil_image, threshold, deepbooru_opts
            )
...
def create_deepbooru_process(threshold, deepbooru_opts):
    ...
    shared.deepbooru_process = context.Process(
        target=deepbooru_process,
        args=(
            shared.deepbooru_process_queue,
            shared.deepbooru_process_return,
            threshold,
            deepbooru_opts,
        ),
    )
